...
function PortfolioOther({ showHeader = true, standalone = true}) {
  ...
  return (
    ...
    <div className={standalone ? "container" : ""}>
          {showHeader && <h1 className="fade-in">Other Projects</h1>}
                    ...
                    {project.images.map((img, index) => (
                      <ImageListItem key={index}>
                        <img
                          ...
                          loading={index === 0 ? "eager" : "lazy"}                          onClick={() => setZoomedImg(img)}
                          style={{ 
                            cursor: "zoom-in", 
                            borderRadius: "10px", 
